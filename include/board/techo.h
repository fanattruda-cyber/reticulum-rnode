...
//  and recalibrate batt_mult against a multimeter via the webflasher's
//  CALIBRATE BATTERY flow.
// =====================================================================

// ---- Board identity ------------------------------------------------
// Codes match markqvist/RNode_Firmware Boards.h. PRODUCT/MODEL are
// written to EEPROM by the webflasher's provisioning panel so rnodeconf
// and Reticulum identify the device correctly.
#define BOARD_NAME              "T-Echo"
#define BOARD_MANUFACTURER      "LilyGO"
#define BOARD_TECHO             0x44
#define PRODUCT_TECHO           0x15
#define MODEL_TECHO             0x17   // 868/915 MHz variant (433 MHz = 0x16)
...
#define DEFAULT_CONFIG_DISPLAY_NAME     "T-Echo"
